...
{{ include_code_sample(path="lessons/old/2021L/04_enums/enums.c", language="c") }}
...
{{ include_code_sample(path="lessons/old/2021L/04_enums/tagged_union.cpp", language="cpp") }}
...
{{ include_code_sample(path="lessons/old/2021L/04_enums/enums.rs", language="rust") }}
...
{{ include_code_sample(path="lessons/old/2021L/04_enums/option.rs", language="rust") }}
...
{{ include_code_sample(path="lessons/old/2021L/04_enums/pattern_matching.rs", language="rust") }}
...
{{ include_code_sample(path="lessons/old/2021L/04_enums/result.rs", language="rust") }}
